...
searchYoutubeURL.js           // YouTubei検索で追加待機キューを作成
addSongToYoutubePlaylist.js   // 待機キューをYouTubeプレイリストに追加
lib/logger.js                 // console.* を terminal.log に書き出す共通処理
lib/runtime.js                // dotenv + logger 初期化の共通処理
lib/paths.js                  // 各種ファイルパス定義の共通処理
```
...
- `npm run search-youtube`: YouTube候補を検索して待機キューを作成
- `npm run add-to-playlist`: 待機キューをYouTubeプレイリストに追加
